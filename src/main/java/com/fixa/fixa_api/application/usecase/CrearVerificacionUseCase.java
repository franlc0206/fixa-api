...
/**
 * Use case: Crear una verificación telefónica y enviar el código por
 * SMS/WhatsApp.
 * Siguiendo arquitectura hexagonal, este use case solo conoce puertos del
 * dominio.
 */
public interface CrearVerificacionUseCase {
     ...
     * @param email    Email address (optional if telephone is provided)
     * @param canal    Canal de envío (sms, whatsapp o email)
     * @param turnoId  ID del turno asociado (opcional, puede ser null)
     * @return VerificacionTelefono creada con el código generado
     */
    VerificacionTelefono ejecutar(String telefono, String email, String canal, Long turnoId);
}
