...
/**
 * Mapper entre VerificacionTelefono (dominio) y VerificacionTelefonoEntity (JPA).
 * Siguiendo arquitectura hexagonal, este mapper pertenece a la capa de infraestructura
